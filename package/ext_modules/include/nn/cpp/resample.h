...
template <typename T>
void ResampleToMap2D(const int64_t num_kernels, at::Tensor data_in,
                     at::Tensor sample_map, const int64_t channels,
                     const int64_t in_height, const int64_t in_width,
                     const int64_t out_height, const int64_t out_width,
                     const int64_t interpolation, at::Tensor data_out) {
...
template <typename T>
void ResampleFromMap2D(const int64_t num_kernels, at::Tensor data_out,
                       at::Tensor sample_map, const int64_t channels,
                       const int64_t in_height, const int64_t in_width,
                       const int64_t out_height, const int64_t out_width,
                       const int64_t interpolation, at::Tensor data_in) {
...
template <typename T>
void ResampleToMap2DWeighted(const int64_t num_kernels, at::Tensor data_in,
                             at::Tensor sample_map, at::Tensor interp_weights,
...
void ResampleFromMap2DWeighted(
    const int64_t num_kernels, at::Tensor data_out, at::Tensor sample_map,
    at::Tensor interp_weights, const int64_t channels, const int64_t in_height,
    const int64_t in_width, const int64_t out_height, const int64_t out_width,
...
template <typename T>
void ResampleToMap2DVoting(const int64_t num_kernels, at::Tensor data_in,
                           at::Tensor sample_map, const int64_t channels,
                           const int64_t in_height, const int64_t in_width,
                           const int64_t out_height, const int64_t out_width,
